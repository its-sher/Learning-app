...
import ApiKeys from '../../container/ui-elements/ApiKeys';
...
const PrivacyPolicy = lazy(() => import('../../container/ui-elements/PrivacyPolicy'));
const RefundPolicy = lazy(() => import('../../container/ui-elements/RefundPolicy'));
...
const SystemSettings = lazy(() => import('../../container/dashboard/SystemSettings'));
const Configurations = lazy(() => import('../../container/dashboard/Configurations'));
const Supports = lazy(() => import('../../container/dashboard/Supports'));
const PaymentMethods = lazy(() => import('../../container/dashboard/PaymentMethods'));
...
const ComponentRoute = () => {
  ...
  return (
    <Switch>
      ...
      <Route path={`${path}/apikeys`} component={ApiKeys} />
      <Route path={`${path}/privacypolicy`} component={PrivacyPolicy} />
      <Route path={`${path}/refundpolicy`} component={RefundPolicy} />
      ...
      {/* // */}
      <Route exact path={`${path}/systemsettings`} component={SystemSettings} />
      {/* // */}
      {/* // */}
      <Route exact path={`${path}/configurations`} component={Configurations} />
      {/* // */}
      {/* // */}
      <Route exact path={`${path}/supports`} component={Supports} />
      {/* // */}
      {/* // */}
      <Route exact path={`${path}/paymentmethods`} component={PaymentMethods} />
      {/* // */}
    </Switch>
  );
};
