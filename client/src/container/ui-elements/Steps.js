...
import { Row, Col } from 'antd';  //Divider
    ...
    <>
      ...
      <Main>
        <Row gutter={25}>
          ...
          <Col md={24} sm={24} xs={24}>
            <Cards title="Details" caption="The simplest use of Steps">
              <Steps current={1} progressDot={customDot}>
                <Step title="Order Placed" description="Your order has been placed on 20-10-2021" />
                <Step title="Shipment In Progress" description="Order is yet to be shipped" />
                <Step title="Shipped" description="Delivery partner is waiting to carry your order" />
                <Step title="Estimated delivery" description="On 25-10-2021" />
              </Steps>
            </Cards>
          </Col>
          {/* <Col md={24} sm={24} xs={24}>
