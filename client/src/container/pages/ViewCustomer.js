                  ...
                  <Form name="sDash_validation-form" form={form} layout="vertical">
                    <Row gutter={30}>
                      <Col md={8} xs={24}>
                        ...
                        >
                          <Input name="" placeholder="First_Name" readOnly />
                        </Form.Item>
                      </Col>
                      <Col md={8} xs={24}>
                        <Form.Item
                        ...
                        >
                          <Input name="" placeholder="Last_Name" readOnly />
                        </Form.Item>
                      </Col>
                      <Col md={8} xs={24}>
                        <Form.Item
                        ...
                        >
                          <Input placeholder="Email" name="" readOnly />
                        </Form.Item>
                      </Col>
                    </Row>
                    <Row gutter={30}>
                      <Col md={8} xs={24}>
                        ...
                        >
                          <Input type="number" placeholder="Phone Number" name="" readOnly />
                        </Form.Item>
                      </Col>
                    </Row>
                  </Form>
...
export default ViewNewCustomer;
