...
import { Row, Col, Form, Input, DatePicker, Select, Table } from 'antd'; // Upload, , Card
import { Button } from '../../../components/buttons/buttons';
import FeatherIcon from 'feather-icons-react';
import { Main, TableWrapper } from '../../../container/styled';
import { useDispatch, useSelector } from 'react-redux';

const EditVariants = ({ formData, setformData }) => {
            ...
            <Col xs={24}>
                ...
                <Row gutter={15}>
                    <Col lg={12} md={12} xs={24}>
                        ...
                        >
                            <Select mode='multiple' options={attributes} onChange={multiHandle}></Select>
